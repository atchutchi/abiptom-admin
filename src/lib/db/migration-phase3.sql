-- ═══════════════════════════════════════════════════════════════
-- Migração Fase 3 — Projectos e Folha Salarial
...
-- ─── 4. Adicionar project_id a invoices ────────────────────────
ALTER TABLE "invoices"
  ADD COLUMN "project_id" uuid REFERENCES "projects"("id") ON DELETE SET NULL;

-- ─── 5. Tabela salary_policies ─────────────────────────────────
...
-- ─── 10. Seed políticas salariais ─────────────────────────────
INSERT INTO salary_policies (nome, versao, descricao, data_inicio, activo, configuracao_json) VALUES
(
  'Política Actual',
  '2024',
...
WHERE table_schema = 'public'
  AND table_name IN ('projects','project_assistants','salary_policies','salary_periods','salary_lines','project_payments','expenses')
ORDER BY table_name;

SELECT nome, versao FROM salary_policies;
